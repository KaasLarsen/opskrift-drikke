// Viser 4 faste, håndplukkede opskrifter på forsiden
const PICKS = [
  {
    tag: "Gløgg",
    title: "Den klassiske gløgg",
    desc: "Varm, krydret og nem at lykkes med.",
    slug: "gloegg-klassisk-0001",
    img: "/assets/recipes/gloegg-klassisk.jpg",
    alt: "Den klassiske gløgg"
  },
  {
    tag: "Kaffe",
    title: "Iskaffe med espresso & mælk",
    desc: "Cremet og forfriskende – perfekt hverdagshack.",
    slug: "iskaffe-espresso-milk-023",
    img: "/assets/recipes/iskaffe-espresso.jpg",
    alt: "Iskaffe med espresso & mælk"
  },
  {
    tag: "Smoothie",
    title: "Jordbær–banan smoothie",
    desc: "Sød, mild og hele familiens favorit.",
    slug: "smoothie-jordbaer-banan-101",
    img: "/assets/recipes/smoothie-jordbaer-banan.jpg",
    alt: "Jordbær–banan smoothie"
  },
  {
    tag: "Juice",
    title: "Grøn morgen-juice",
    desc: "Sprød, frisk og fuld af grønt.",
    slug: "gron-morgen-juice-077",
    img: "/assets/recipes/gron-juice.jpg",
    alt: "Grøn morgen-juice"
  }
];

function cardHTML(p) {
  return `
  <a href="/pages/opskrift.html?slug=${encodeURIComponent(p.slug)}"
     class="card overflow-hidden hover:shadow transition block border bg-white">
